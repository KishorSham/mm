      ...
      <div class="col-md-5 static">
        <div class="box1" style="background-image:url(images/vbr.jpg);">
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <button type="button" class="btn2 btn-primary"><a href="menus.php">Order Online</a></button>
              </div>
            </div>
      ...
      <div class="col-md-6 right">
          ...
          <form class="post">
            <div class="input-group">
              ...
              <span class="input-group-addon"><i class="glyphicon glyphicon-camera"></i></span><span class="input-group-addon"><i class="glyphicon glyphicon-upload"></i></span> 
